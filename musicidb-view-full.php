					...
					if( !empty( $event->get_date() ) ):
						...
						<li id="event-<?php esc_attr_e( $event->get_id() ); ?>" class="summaryContent listEvent listItem cf">
							...
							<div class="eventPosterArea">
										...
										<?php 
											if( !empty( $event->get_poster() ) ) {
												...
												if( stripos($event_thumbnail, '/event/logo/') === false ) {
				                                    ...
				                                    $thumbnail_src = musicidb_get_image_at_size( $event_thumbnail, 'LargeMedium' );
											...
											<?php if( !empty( $artist ) ): ?>
												<div class="bandPicBox">
													<?php if( !empty( $artist->get_image_url() ) ): ?>
														<img src="<?php echo musicidb_get_image_at_size( $artist->get_image_url(), 'LargeMedium' ); ?>" class="artistReplace alignleft" />
													<?php endif; ?>
												</div>
											<?php endif; ?>
										<?php endforeach; ?>
								...
								<?php else: ?>
									<div>
										<img src="<?php echo esc_url( plugins_url('/images/defaultEvent.png', MUSICIDB_PLUGIN ), array( 'http', 'https' ) ); ?>" class="artistReplace alignleft defaultPic" />
									</div>
								<?php endif; ?>
